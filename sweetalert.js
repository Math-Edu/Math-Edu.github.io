...
!function(e, t) {
    ...
    e)), {})
      ...
      , z = (e,t)=>{
        ...
        for (let e = 0; e < n.length; e++) {
            const o = n[e];
            if (o instanceof HTMLElement && q(o, t))
                return o
        }
    }
      , W = (e,t,n)=>{
      ...
      , ee = function(e) {
        ...
        const n = O();
        n && X(n) && (t && (n.style.transition = "none",
        n.style.width = "100%"),
        setTimeout((()=>{
      ...
      , ce = (e,t)=>{
        const n = L()
          , o = T();
        n && o && (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? K(n) : Y(n),
        V(n, t, "actions"),
        function(e, t, n) {
            const o = E()
              , s = P()
            ...
            e.insertBefore(s, o)) : (e.insertBefore(r, t),
            e.insertBefore(s, t),
            e.insertBefore(o, t)))
        }(n, o, t),
        D(o, t.loaderHtml || ""),
    ...
    const Ce = (e,t)=>{
        const o = A();
        o && (V(o, t, "htmlContainer"),
        t.html ? (se(t.html, o),
        K(o, "block")) : t.text ? (o.textContent = t.text,
        K(o, "block")) : Y(o),
        ((e,t)=>{
            const o = w();
            if (!o)
      ...
      , Le = (e,t)=>{
        ...
        ((e,t)=>{
            ...
            o && 0 !== o.length && void 0 !== s ? (K(n),
            n.textContent = "",
            s >= o.length && l("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            o.forEach(((e,r)=>{
                const a = Pe(e);
                if (n.appendChild(a),
        ...
        ((e,t)=>{
            const n = C();
            n && (J(n, t.title || t.titleText, "block"),
      ...
      , De = (e,t,o)=>{
        ...
        "Enter" === t.key ? qe(e, t, i) : "Tab" === t.key ? Ve(t) : [...Ie, ...He].includes(t.key) ? Ne(t.key) : "Escape" === t.key && Fe(t, i, o)))
    }
      , qe = (e,t,n)=>{
      ...
      , Ne = e=>{
        ...
        for (let e = 0; e < L().children.length; e++) {
            ...
            !o)
                return;
            if (o instanceof HTMLButtonElement && X(o))
                break
        }
    ...
    ;
    function Xe(n, o, s, r) {
        H() ? st(n, r) : (t(s).then((()=>st(n, r))),
        Me(e)),
        Ue ? (o.setAttribute("style", "display:none !important"),
    ...
    const Qe = e=>{
        ...
        if (!t)
            return !1;
        const o = n.innerParams.get(e);
        if (!o || q(t, o.hideClass.popup))
            return !1;
        U(t, o.showClass.popup),
        R(t, o.hideClass.popup);
        const i = f();
    ...
    const tt = e=>{
      ...
      , ot = (e,t,n)=>{
        ...
        i ? it(e, t, o, n.returnFocus, n.didClose) : Xe(e, o, n.returnFocus, n.didClose)
    }
      , it = (t,n,o,i,s)=>{
        e.swalCloseEventFinishedCallback = Xe.bind(null, t, o, i, s),
        n.addEventListener(le, (function(t) {
            t.target === n && (e.swalCloseEventFinishedCallback(),
      ...
      , ut = e=>e.files && e.files.length ? null !== e.getAttribute("multiple") ? e.files : e.files[0] : null
      , dt = (e,t)=>{
        const n = w();
        if (!n)
            return;
        const o = e=>{
            "select" === t.input ? function(e, t, n) {
                ...
                o.focus()
            }(n, mt(e), t) : "radio" === t.input && function(e, t, n) {
                const o = z(e, i.radio);
                if (!o)
                    return;
                t.forEach((e=>{
    ...
    const mt = e=>{
      ...
      , ht = (e,t)=>{
        ...
        o.inputValidator ? ft(e, s, t) : i && !i.checkValidity() ? (e.enableButtons(),
        e.showValidationMessage(o.validationMessage)) : "deny" === t ? bt(e, s) : vt(e, s)
    }
      , ft = (e,t,o)=>{
        const i = n.innerParams.get(e);
        e.disableInput();
    ...
    function Lt(e) {
        ...
        o.customClass && o.customClass.validationMessage && R(t.validationMessage, o.customClass.validationMessage),
    ...
    function Ut() {
        const t = n.domCache.get(this)
          , o = n.innerParams.get(this);
        o ? (t.popup && e.swalCloseEventFinishedCallback && (e.swalCloseEventFinishedCallback(),
        delete e.swalCloseEventFinishedCallback),
    ...
    const zt = t=>{
      ...
      , Wt = e=>{
        e.isAwaitingPromise ? (Kt(n, e),
        e.isAwaitingPromise = !0) : (Kt(_e, e),
        Kt(n, e),
    ...
    const Zt = (e,t,o)=>{
      ...
      , Jt = e=>e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton;
    let Xt = !1;
    const Gt = e=>{
        e.popup.onmousedown = ()=>{
      ...
      , en = (e,t,o)=>{
        t.container.onclick = i=>{
            const s = n.innerParams.get(e);
            Xt ? Xt = !1 : i.target === t.container && p(s.allowOutsideClick) && o(Oe.backdrop)
        }
    }
      , tn = e=>e instanceof Element || (e=>"object" == typeof e && e.jquery)(e);
    const nn = ()=>{
        if (e.timeout)
            return (()=>{
                const e = O();
    ...
    var ln = Object.freeze({
        ...
        argsToParams: e=>{
            const t = {};
            return "object" != typeof e[0] || tn(e[0]) ? ["title", "html", "icon"].forEach(((n,o)=>{
                const i = e[o];
                "string" == typeof i || tn(i) ? t[n] = i : void 0 !== i && c(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`)
            }
            )) : Object.assign(t, e[0]),
            t
        }
        ...
        bindClickHandler: function() {
            rn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
            sn || (document.body.addEventListener("click", an),
            sn = !0)
        },
    ...
    const un = ["swal-title", "swal-html", "swal-footer"]
      , dn = e=>{
        ...
        return Array.from(e.querySelectorAll("swal-param")).forEach((e=>{
            ...
            t[n] = "boolean" == typeof Ot[n] ? "false" !== o : "object" == typeof Ot[n] ? JSON.parse(o) : o
        }
        )),
        t
    }
      ...
      , gn = e=>{
        ...
        return n && (wn(n, ["src", "width", "height", "alt"]),
      ...
      , fn = e=>{
        ...
        n && (wn(n, ["type", "label", "placeholder", "value"]),
      ...
      , yn = e=>{
        const t = un.concat(["swal-param", "swal-function-param", "swal-button", "swal-image", "swal-icon", "swal-input", "swal-input-option"]);
      ...
      , Cn = e=>{
        ...
        if (e.target !== t)
            return;
        const n = f();
        t.removeEventListener(le, Cn),
        n.style.overflowY = "auto"
    }
      , An = (e,t)=>{
        le && Q(t) ? (e.style.overflowY = "hidden",
        t.addEventListener(le, Cn)) : e.style.overflowY = "auto"
    }
      , kn = (e,t,n)=>{
        (()=>{
      ...
      , Bn = (e,t,n)=>{
        ...
        K(t, "grid"),
        setTimeout((()=>{
            R(t, n.showClass.popup),
            t.style.removeProperty("opacity")
        }
        ), 10),
        R([document.documentElement, document.body], i.shown),
        n.heightAuto && n.backdrop && !n.toast && R([document.documentElement, document.body], i["height-auto"])
    }
    ;
    var $n = {
    ...
    function En(e) {
        !function(e) {
            e.inputValidator || ("email" === e.input && (e.inputValidator = $n.email),
    ...
    const Tn = (t,o,i)=>new Promise(((s,r)=>{
        const a = e=>{
            t.close({
                isDismissed: !0,
                dismiss: e
        ...
        ,
        ((e,t,o)=>{
            n.innerParams.get(e).toast ? Zt(e, t, o) : (Gt(t),
            Qt(t),
            en(e, t, o))
        }
        )(t, o, a),
        ((e,t,n,o)=>{
            Me(t),
            n.toast || (t.keydownHandler = t=>De(e, t, o),
        ...
        ((e,t)=>{
            "select" === t.input || "radio" === t.input ? dt(e, t) : ["text", "email", "number", "tel", "textarea"].some((e=>e === t.input)) && (m(t.inputValue) || h(t.inputValue)) && (rt(E()),
            pt(e, t))
        }
        )(t, i),
        vn(i),
      ...
      , Ln = (e,t)=>{
        ...
        return o.showClass = Object.assign({}, Ot.showClass, o.showClass),
      ...
      , jn = (e,t)=>t.focusDeny && X(e.denyButton) ? (e.denyButton.focus(),
